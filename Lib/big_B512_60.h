...
#ifndef BIG_B512_60_H
#define BIG_B512_60_H
...
#define BIGBITS_B512_60 (8*MODBYTES_B512_60)
#define NLEN_B512_60 (1+((8*MODBYTES_B512_60-1)/BASEBITS_B512_60))
#define DNLEN_B512_60 2*NLEN_B512_60
#define BMASK_B512_60 (((chunk)1<<BASEBITS_B512_60)-1) /**< Mask = 2^BASEBITS-1 */
#define NEXCESS_B512_60 (1<<(CHUNK-BASEBITS_B512_60-1))           /**< 2^(CHUNK-BASEBITS-1) - digit cannot be multiplied by more than this before normalisation */

#define HBITS_B512_60 (BASEBITS_B512_60/2)      /**< Number of bits in number base divided by 2 */
#define HMASK_B512_60 (((chunk)1<<HBITS_B512_60)-1)    /**< Mask = 2^HBITS-1 */

//#define DEBUG_NORM

#ifdef DEBUG_NORM  /* Add an extra location to track chunk extension */
#define MPV_B512_60 NLEN_B512_60
#define MNV_B512_60 (NLEN_B512_60+1)
#define DMPV_B512_60 DNLEN_B512_60
#define DMNV_B512_60 (DNLEN_B512_60+1)
...
#ifdef DEBUG_NORM
typedef chunk BIG[NLEN_B512_60 + 2]; /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B512_60 + 2]; /**< Define type DBIG as array of chunks */
#else
typedef chunk BIG[NLEN_B512_60];     /**< Define type BIG as array of chunks */
typedef chunk DBIG[DNLEN_B512_60];   /**< Define type DBIG as array of chunks */
#endif
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_cswap(BIG x, BIG y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_cmove(BIG x, BIG y, int s);
 ...
 *
    ...
    @return ignore
 */
extern chunk BIG_dcmove(BIG x, BIG y, int s);
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    *r = (chunk)prod & BMASK_B512_60;
    return (chunk)(prod >> BASEBITS_B512_60);
}
...
inline chunk muladd(chunk x, chunk y, chunk c, chunk *r)
{
    ...
    top = x1 * y1;
    mid = x0 * y1 + x1 * y0;
    x0 = mid & HMASK_B512_60;
    x1 = (mid >> HBITS_B512_60);
    bot += x0 << HBITS_B512_60;
    bot += *r;
    bot += c;

    top += x1;
    carry = bot >> BASEBITS_B512_60;
    bot &= BMASK_B512_60;
    top += carry;
